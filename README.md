# 👋 안녕하세요! <br>
저는 현재 대구소프트웨어마이스터고에 재학 중이며, 백엔드 개발자를 꿈꾸며 공부하고 있는 문정훈입니다. <br>
...
🌱 learning spring boot and mysql

📧 mjh090801abc.dgsw.hs.kr

🌐 1408moonjunghoon.notion.site <br>


학교에 입학하기 전에는 전공도 정하지 못했고, 코딩 경험도 거의 없었지만,
재학 후 저의 전공을 선택하고 꿈을 이루기 위해 다양한 기술 스택을 쌓고 있습니다.
...
끊임없이 배우고 성장하며, 단순히 코드를 작성하는 것에 그치지 않고, 실제로 사람들이 사용할 수 있는 서비스와 프로젝트를 만들어보고, 
다양한 문제를 직접 해결하면서 경험을 쌓고, 더 나은 개발자로 성장하는 것을 목표로 하고 있습니다.
